...
#ifdef DISC01
/*Stub*/
void do_composicion(Pol_Directory& the_directory,string& op1,string& op2,string& var){
...
void do_composicion(Pol_Directory& the_directory,string& op1,string& op2,string& var){
	...
	string string_pol_composicion=var;
	...
	the_directory.add_or_change_entry(string_pol_composicion,resultado);	
}
#endif
